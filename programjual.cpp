...
do {
	...
	if (nomor == 0)
	{
			 ...
			 if (beli =='y' || beli =='Y') 
			 {
				keranjang[n].paket  = paket[0];	
				keranjang[n].detail = detail[0];
	...
	else if (nomor == 1)
		{
			 ...
			 if (beli =='y' || beli =='Y') 
			 {
				keranjang[n].paket  = paket[1];	
				keranjang[n].detail = detail[1];	
		...
		else  // jika n tidak < 1
		{
			...
			cout<<"Paket : "<<keranjang[j].paket<<endl; 
			cout<<"Detail barang : "<<keranjang[j].detail<<endl; 
...
}while (nomor == 0 || nomor == 1 || nomor == 98); 
